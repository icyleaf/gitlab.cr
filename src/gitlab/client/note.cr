  ...
  class Client
    ...
    module Note
      ...
      def issue_notes(project_id : Int32, issue_id : Int32, params : Hash? = nil)
        get("/projects/#{project_id}/issues/#{issue_id}/notes", params).body.parse_json
      end
      ...
      def issue_note(project_id : Int32, issue_id : Int32, note_id : Int32)
        get("/projects/#{project_id}/issues/#{issue_id}/notes/#{note_id}").body.parse_json
      end
      ...
      def edit_issue_note(project_id : Int32, issue_id : Int32, note_id : Int32, body : String)
        put("/projects/#{project_id}/issues/#{issue_id}/notes/#{note_id}", {
          "body" => body
        }).body.parse_json
      end
      ...
      def delete_issue_note(project_id : Int32, issue_id : Int32, note_id : Int32)
        delete("/projects/#{project_id}/issues/#{issue_id}/notes/#{note_id}").body.parse_json
      end
      ...
      def snippet_notes(project_id : Int32, snippet_id : Int32, params : Hash? = nil)
        get("/projects/#{project_id}/snippets/#{snippet_id}/notes", params).body.parse_json
      end
      ...
      def snippet_note(project_id : Int32, snippet_id : Int32, note_id : Int32)
        get("/projects/#{project_id}/snippets/#{snippet_id}/notes/#{note_id}").body.parse_json
      end
      ...
      def edit_snippet_note(project_id : Int32, snippet_id : Int32, note_id : Int32, body : String)
        put("/projects/#{project_id}/snippets/#{snippet_id}/notes/#{note_id}", {
          "body" => body
        }).body.parse_json
      end
      ...
      def delete_snippet_note(project_id : Int32, snippet_id : Int32, note_id : Int32)
        delete("/projects/#{project_id}/snippets/#{snippet_id}/notes/#{note_id}").body.parse_json
      end
      ...
      def merge_request_notes(project_id : Int32, merge_request_id : Int32, params : Hash? = nil)
        get("/projects/#{project_id}/merge_requests/#{merge_request_id}/notes", params).body.parse_json
      end
      ...
      def merge_request_note(project_id : Int32, merge_request_id : Int32, note_id : Int32)
        get("/projects/#{project_id}/merge_requests/#{merge_request_id}/notes/#{note_id}").body.parse_json
      end
      ...
      def edit_merge_request_note(project_id : Int32, merge_requests_id : Int32, note_id : Int32, body : String)
        put("/projects/#{project_id}/merge_requests/#{merge_requests_id}/notes/#{note_id}", {
          "body" => body
        }).body.parse_json
      end
      ...
      def delete_merge_request_note(project_id : Int32, merge_request_id : Int32, note_id : Int32)
        delete("/projects/#{project_id}/merge_requestss/#{merge_request_id}/notes/#{note_id}").body.parse_json
      end
    end
  end
end
